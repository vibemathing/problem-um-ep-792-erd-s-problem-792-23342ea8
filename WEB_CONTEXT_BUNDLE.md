...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-792-erd-s-problem-792-23342ea8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-792"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-792-erd-s-problem-792-23342ea8-v1",
      "problem_contract_sha256": "4053e331b3d96cc1bd771029a73d1073c875433fae56e86100010ec2449dd3d4",
      "problem_id": "problem:um-ep-792-erd-s-problem-792-23342ea8",
      "route_id": "route:um-ep-792-erd-s-problem-792-23342ea8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-792-erd-s-problem-792-23342ea8-source-fidelity-01",
      "graph_id": "graph:um-ep-792-erd-s-problem-792-23342ea8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-792-erd-s-problem-792-23342ea8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-792-erd-s-problem-792-23342ea8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(n)$ be maximal such that in any $A\\subset \\mathbb{Z}$ with $\\lvert A\\rvert=n$ there exists some sum-free subset $B\\subseteq A$ with $\\lvert B\\rvert \\geq f(n)$, so that there are no solutions to $ a+b=c $ with $a,b,c\\in B$. Estimate $f(n)$."
          },
          "statement_sha256": "dcb96d3a3c3e8e835ecfef0ddffd1cf6fbe9a7782c3ac5bfb48e9ca0b8d283cd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-792-erd-s-problem-792-23342ea8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-792-erd-s-problem-792-23342ea8-root",
      "route_id": "route:um-ep-792-erd-s-problem-792-23342ea8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-792-b2ccd3350de5",
        "url": "https://www.unsolvedmath.com/problems/EP-792"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
